...
<body>
    ...
    $searchQuery = "SELECT * FROM news WHERE id = $newsid;";
    ...
    <h1 class="mt-3 text-center main-text"> <?php echo strtoupper($row['category']); ?></h1>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text"><small class="text-muted"> <i class="bi bi-person-circle"></i><?php echo " Reporter : " . $row['reportername']; ?></small></p>
